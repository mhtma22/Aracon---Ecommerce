        ...
        <div className="flex items-center gap-2 opacity-80" aria-label="Métodos de pago aceptados">
          <span className="bg-[#FFFFFF] px-2 py-1 rounded border border-[#D6DCD5] text-[10px] font-mono text-[#5A6A63]">
            <Image
              ...
              height={30}
              loading="lazy"
              className={`w-auto object-contain filter grayscale contrast-125 hover:scale-105 transition-transform duration-200}`}
            />
          </span>
          <span className="bg-[#FFFFFF] px-2 py-1 rounded border border-[#D6DCD5] text-[10px] font-mono text-[#5A6A63]">
            <Image
          ...
          <span className="bg-[#FFFFFF] px-2 py-1 rounded border border-[#D6DCD5] text-[10px] font-mono text-[#5A6A63]">
            <Image
              src={'/yape.png'}
              alt={`Logotipo de Yape`}
              width={1}
              height={1}
              loading="lazy"
              className={`w-auto grayscale contrast-125 hover:scale-105 transition-transform duration-200}`}
